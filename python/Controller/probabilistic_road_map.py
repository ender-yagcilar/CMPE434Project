...
class PRM:
    def __init__(self, sx, sy, gx, gy, robot_size, ox, oy,rng):
        self.sx = sx
        self.sy = sy
        self.gx = gx
        self.gy = gy
    ...
    def prm_planning(self,start_x, start_y, goal_x, goal_y,
        ...
        if show_animation:
            plt.plot(obstacle_x_list, obstacle_y_list, ".k", markersize=5)
            plt.plot(start_x, start_y, "^r", markersize=10)
            plt.plot(goal_x, goal_y, "^m", markersize=10)
            plt.grid(True)
            plt.axis("equal")
        ...
        rx, ry,is_path_found = self.dijkstra_planning(
            start_x, start_y, goal_x, goal_y, road_map, sample_x, sample_y)
        

        return rx, ry,is_path_found
